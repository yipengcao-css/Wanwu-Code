...
**下一步（2026-09-21）**：上列体感项与 Debug / Browser / Tab 下一跳 / Ctrl+K 升格 / MCP HTTP+OAuth / 扩展侧栏均已落地。余下是产品选择，不是漏做：Cloud Agents、Bugbot、DAP、Browser 点击、MCP prompts、`crates/` 空、插件注册表未上线。不要再按 `CURSOR_PARITY` 旧空缺表施工。
